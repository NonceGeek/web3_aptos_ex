defmodule Web3AptosEx.Starcoin.Caller.ContractTest do
  @moduledoc false

  use ExUnit.Case, async: true

  # doctest Web3AptosEx.Caller.Contract

  import Mox

  alias Web3AptosEx.Starcoin.Caller.Contract

  setup :verify_on_exit!

  setup_all do
    endpoint = Web3AptosEx.Constant.endpoint(:local)
    %{endpoint: endpoint}
  end
